...
def test_detects_conversion_on_day_paid_appears():
    state = build_initial_state(_member(CommunityType.FREE, "2024-01-01", skool_member_id="free-1"))
    state = apply_membership(state, _member(CommunityType.FREE, "2024-01-01", skool_member_id="free-1"), CommunityType.FREE, "2024-01-01 10:00:00")
    state = apply_membership(state, _member(CommunityType.PAID, "2024-01-05", skool_member_id="paid-1"), CommunityType.PAID, "2024-01-05 14:30:00")
...
def test_conversion_date_preserved_across_runs():
    state = build_initial_state(_member(CommunityType.FREE, "2024-01-01", skool_member_id="free-2"))
    state = apply_membership(state, _member(CommunityType.FREE, "2024-01-01", skool_member_id="free-2"), CommunityType.FREE, "2024-01-01 10:00:00")
    state = apply_membership(state, _member(CommunityType.PAID, "2024-01-05", skool_member_id="paid-2"), CommunityType.PAID, "2024-01-05 14:30:00")
...
def test_both_status_when_active_in_both():
    state = build_initial_state(_member(CommunityType.FREE, "2024-01-01", skool_member_id="free-3"))
    state = apply_membership(state, _member(CommunityType.FREE, "2024-01-01", skool_member_id="free-3"), CommunityType.FREE, "2024-01-01 10:00:00")
    state = apply_membership(state, _member(CommunityType.PAID, "2024-01-02", skool_member_id="paid-3"), CommunityType.PAID, "2024-01-02 14:30:00")
    states = detect_conversions({"jane|doe": state})
    assert states["jane|doe"].current_status == "converted"


def test_email_carried_into_state():
    member = _member(CommunityType.FREE, "2024-01-01", email="jane@example.com", skool_member_id="free-4")
    state = build_initial_state(member)
    assert state.email == "jane@example.com"
    state = apply_membership(state, _member(CommunityType.PAID, "2024-01-02", skool_member_id="paid-4"), CommunityType.PAID, "2024-01-02 14:30:00")
    assert state.email == "jane@example.com"
